...
(function( root, factory ) {
	...
	function setupPDF() {
		...
		// Compute slide numbers now, before we mess with the layout
		var doingSlideNumbers = config.slideNumber && /all|print/i.test( config.showSlideNumber );
		toArray( dom.wrapper.querySelectorAll( SLIDES_SELECTOR ) ).forEach( function( slide ) {
			slide.setAttribute( 'data-slide-number', getSlideNumber( slide, false ) );
		} );
	 ...
	 *
	 * Alternatively, config.slideNumber can be a function taking in a slide
	 * and returning a three-element array with arguments to
	 * formatSlideNumber().
	 */
	...
	/**
	 * Returns the string corresponding to the current slide number.
	 * See updateSlideNumber() for config options.
	 *
	 * @param {HTMLElement} [slide=currentSlide] The slide we're numbering
